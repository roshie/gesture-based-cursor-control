...
args = {
	"input": "labels_ibug_300W_train.xml",
	"output": "labels_ibug_300W_train_opt.xml"
}

# args = {
# 	"input": "labels_ibug_300W_test.xml",
# 	"output": "labels_ibug_300W_test_opt.xml"
# }
...
LANDMARKS = set(list(range(17, 27)) + list(range(36, 48)) + list([30]))
print(LANDMARKS)
